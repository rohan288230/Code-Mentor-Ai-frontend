...
const modules = [
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "In which year was Python officially released?",
          "options": [
            "1985",
            "1991",
            "1998",
        ...
        {
          "questionText": "Python is primarily known for which feature?",
          "options": [
            "Complex Syntax",
            "Readability",
        ...
        {
          "questionText": "Which of the following is a popular Python web framework?",
          "options": [
            "Spring",
            "Laravel",
            "Django",
        ...
        {
          "questionText": "Python is classified as which type of language?",
          "options": [
            "Assembly Language",
            "Markup Language",
        ...
        {
          "questionText": "Which company uses Python extensively for AI development?",
          "options": [
            "OpenAI",
            "Netflix",
            "Google",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Which data type stores whole numbers?",
          "options": [
            "float",
            "str",
            "bool",
        ...
        {
          "questionText": "Which data type stores decimal numbers?",
          "options": [
            "int",
            "bool",
            "float",
        ...
        {
          "questionText": "Which data type is used to store text?",
          "options": [
            "str",
            "int",
            "float",
        ...
        {
          "questionText": "What are the two boolean values in Python?",
          "options": [
            "Yes and No",
            "1 and 0",
            "True and False",
        ...
        {
          "questionText": "Python is a ______ typed language.",
          "options": [
            "Static",
            "Dynamic",
            "Compiled",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        {
          "questionText": "Which statement is used to make decisions in Python?",
          "options": ["loop", "if", "function", "module"],
          "correctAnswer": "if"
        },
        {
          "questionText": "Which keyword is used for alternative execution?",
          "options": ["elseif", "elif", "alternative", "switch"],
          "correctAnswer": "elif"
        },
        {
        ...
        {
          "questionText": "Which logical operator returns True when both conditions are True?",
          "options": ["or", "not", "and", "xor"],
          "correctAnswer": "and"
        },
        {
          "questionText": "What is a nested condition?",
          "options": [
            "Loop inside loop",
          ...
          "correctAnswer": "If inside another if"
        }
      ]
    }
  },
      ...
      "questions": [
        {
          ...
          "options": ["while", "for", "do-while", "nested"],
          "correctAnswer": "for"
        },
        {
          "questionText": "Which function generates a sequence of numbers?",
          "options": ["list()", "range()", "number()", "generate()"],
          "correctAnswer": "range()"
        },
        {
          "questionText": "Which loop runs while a condition remains True?",
          "options": ["for", "nested", "while", "range"],
          "correctAnswer": "while"
        },
        {
          "questionText": "Which statement exits a loop immediately?",
          "options": ["continue", "pass", "skip", "break"],
          "correctAnswer": "break"
        },
        {
...
const seedDB = async () => {
  try {
    ...
    // Look for a Python course or create one
    let course = await Course.findOne({ title: { $regex: /python/i } });
    if (!course) {
      course = new Course({
        title: "Python Programming",
        description: "Master Python programming from scratch. Covers variables, loops, conditions, and more.",
        language: "python"
      });
      await course.save();
      console.log('Created new Python Course.');
    } else {
      console.log('Found existing Python Course.');
    }
    ...
    for (let i = 0; i < modules.length; i++) {
      ...
      let moduleDoc = await Module.findOne({ title: mod.title, course: course._id });
      if (!moduleDoc) {
        ...
        // Add module to course if not present
        if (!course.modules.includes(moduleDoc._id)) {
      ...
      for (let j = 0; j < mod.lessons.length; j++) {
        ...
        let lessonDoc = await Lesson.findOne({ title: lesson.title, module: moduleDoc._id });
        if (!lessonDoc) {
          ...
          if (!moduleDoc.lessons.includes(lessonDoc._id)) {
      ...
      // Quiz
      let quizDoc = await Quiz.findOne({ module: moduleDoc._id });
      if (!quizDoc && mod.quiz) {
        ...
        await moduleDoc.save();
        console.log(`Created Quiz for: ${mod.title}`);
      }
    }
