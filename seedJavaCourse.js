...
const modules = [
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Java was originally called:",
          "options": [
            "Oak",
            "Pine",
            "Cedar",
        ...
        {
          "questionText": "Which feature makes Java platform independent?",
          "options": [
            "Compiler",
            "JVM",
            "IDE",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Which Java data type is used to store whole numbers?",
          "options": [
            "float",
            "boolean",
            "int",
        ...
        {
          "questionText": "Which non-primitive data type is used to store text?",
          "options": [
            "char",
            "String",
            "boolean",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        {
          "questionText": "Which operator is used for addition in Java?",
          "options": [
            "+",
            "-",
            "*",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        {
          "questionText": "Which statement is used for decision making in Java?",
          "options": [
            "for",
            "while",
            "if",
        ...
        {
          "questionText": "Which statement is used when multiple conditions need to be checked?",
          "options": [
            "if",
            "switch",
            "else-if ladder",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Which Java loop guarantees at least one execution?",
          "options": [
            "for",
            "while",
            "do-while",
...
const seedDB = async () => {
  try {
    ...
    // Look for a Java Programming course or create one
    let course = await Course.findOne({ title: { $regex: /Java Programming/i } });
    if (!course) {
      course = new Course({
      ...
      await course.save();
      console.log('Created new Java Programming Course.');
    } else {
      console.log('Found existing Java Programming Course.');
    }
