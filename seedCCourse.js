...
const modules = [
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "In which year was C developed?",
          "options": [
            "1972",
            "1985",
            "1991",
        ...
        {
          "questionText": "Which header file is commonly used for input and output operations?",
          "options": [
            "math.h",
            "string.h",
            "stdio.h",
        ...
        {
          "questionText": "Which function is used to display output in C?",
          "options": [
            "scanf()",
            "print()",
            "printf()",
      ...
      "questions": [
        {
          ...
          "correctAnswer": "A memory location used to store data"
        },
        {
        ...
        {
          "questionText": "Which format specifier is used for integers?",
          "options": [
            "%f",
            "%c",
            "%d",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Which operator increases a value by one?",
          "options": [
            "--",
            "++",
            "+=",
...
const seedDB = async () => {
  try {
    ...
    if (!course) {
      course = new Course({
        title: "C Programming",
        description: "Master C Programming from scratch. Covers variables, operators, conditions, loops, and more.",
        language: "c"
      });
      await course.save();
