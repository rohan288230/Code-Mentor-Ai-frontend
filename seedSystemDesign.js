...
const modules = [
  {
    ...
    "learningObjectives": [
      ...
      "Learn why System Design is important",
      "Understand software architecture basics",
      "Learn High-Level Design (HLD)",
      "Learn Low-Level Design (LLD)",
      "Understand modern application architecture",
      "Identify system components",
      "Build a foundation for advanced System Design"
    ],
    "lessons": [
      {
      ...
      "questions": [
        {
          ...
          "correctAnswer": "Designing scalable and reliable systems"
        },
        {
          ...
          "correctAnswer": "High-Level Design"
        },
        {
  ...
  },
  {
    ...
    "learningObjectives": [
      ...
      "Learn availability and reliability",
      "Understand capacity planning",
      "Apply scalability concepts to real-world systems"
    ],
    "lessons": [
      {
      ...
      "questions": [
        {
          ...
          "correctAnswer": "Handling increasing traffic and data efficiently"
        },
        {
          ...
          "correctAnswer": "Increasing resources of a single server"
        },
        {
  ...
  },
  {
    ...
    "learningObjectives": [
      ...
      "Learn why Load Balancing is important",
      ...
      "Apply Load Balancing in real-world architectures"
    ],
    "lessons": [
      {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        },
        {
          ...
          "correctAnswer": "Monitor server availability"
        },
        {
        ...
        },
        {
          ...
          "correctAnswer": "Traffic is redirected to healthy servers"
        }
      ]
    }
  },
  {
    ...
    "learningObjectives": [
      ...
      "Understand cache hit and cache miss",
      "Learn caching architectures",
      "Understand Redis and Memcached",
      "Learn cache eviction policies",
      "Understand Content Delivery Networks",
      "Apply caching in real-world systems"
    ],
    "lessons": [
      {
      ...
      "questions": [
        {
          ...
          "correctAnswer": "Reduce latency and improve performance"
        },
        {
  ...
  },
  {
    ...
    "learningObjectives": [
      ...
      "Apply database concepts in system design"
    ],
    "lessons": [
      {
...
const seedDB = async () => {
  try {
    ...
    if (!subject) {
      subject = new SystemDesignSubject({
      ...
      await subject.save();
      console.log('Created SystemDesignSubject.');
    } else {
      console.log('SystemDesignSubject already exists.');
    }

    // Now seed the modules
    for (let i = 0; i < modules.length; i++) {
      const mod = modules[i];
      let topic = await SystemDesignTopic.findOne({ title: mod.title, subjectId: subject._id });
      if (!topic) {
        topic = new SystemDesignTopic({
        ...
        await topic.save();
        console.log(`Created SystemDesignTopic: ${mod.title}`);
      } else {
        console.log(`SystemDesignTopic already exists: ${mod.title}`);
      }

      // Notes
      let notes = await SystemDesignNotes.findOne({ topicId: topic._id });
      if (!notes) {
        let contentStr = '';
        ...
        // Update the topic with the notes reference
        topic.notes = notes._id;
        await topic.save();
        console.log(`Created SystemDesignNotes for: ${mod.title}`);
      }

      // Quiz
      let quiz = await SystemDesignQuiz.findOne({ topicId: topic._id });
      if (!quiz) {
        ...
        // Update the topic with the quiz reference
        topic.quiz = quiz._id;
        await topic.save();
        console.log(`Created SystemDesignQuiz for: ${mod.title}`);
      }
    }
