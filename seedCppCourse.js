...
const modules = [
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "C++ was originally called:",
          "options": [
            "Advanced C",
            "C with Classes",
            "Object C",
        ...
        {
          "questionText": "Which header file is used for cin and cout?",
          "options": [
            "stdio.h",
            "math.h",
            "iostream",
        ...
        {
          "questionText": "Which programming paradigm is strongly supported by C++?",
          "options": [
            "Markup Programming",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "What is the purpose of constants?",
          "options": [
          ...
          "correctAnswer": "Store fixed values"
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Which logical operator represents AND?",
          "options": [
            "||",
            "&&",
            "!",
        ...
        {
          "questionText": "Which operator increases a variable's value by one?",
          "options": [
            "--",
            "++",
            "+=",
  ...
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        {
          "questionText": "Which statement is used for decision making in C++?",
          "options": [
            "for",
            "while",
            "if",
        ...
        {
          "questionText": "Which statement is useful when multiple conditions need to be checked?",
          "options": [
            "if",
            "switch",
            "else-if ladder",
        ...
        },
        {
          ...
          "correctAnswer": "Executes when no case matches"
        }
      ]
    }
  },
  {
    ...
    "quiz": {
      ...
      "questions": [
        ...
        {
          "questionText": "Which statement immediately exits a loop?",
          "options": [
            "continue",
            "break",
            "return",
        ...
        {
          "questionText": "Which statement skips the current iteration and moves to the next one?",
          "options": [
            "continue",
            "break",
            "exit",
...
const seedDB = async () => {
  try {
    ...
    // Look for a C++ Programming course or create one
    let course = await Course.findOne({ title: { $regex: /C\+\+ Programming/i } });
    if (!course) {
      course = new Course({
        title: "C++ Programming",
        description: "Master C++ Programming from scratch. Covers variables, operators, conditions, loops, object-oriented concepts and more.",
        language: "cpp"
      });
      await course.save();
      console.log('Created new C++ Programming Course.');
    } else {
      console.log('Found existing C++ Programming Course.');
    }
